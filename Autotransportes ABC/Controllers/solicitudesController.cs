...
namespace Autotransportes_ABC.Controllers
{
    public class solicitudesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_solicitud,lote,fecha")] solicitudes solicitudes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_solicitud,lote,fecha")] solicitudes solicitudes)
        {
            if (ModelState.IsValid)
            {
